  ...
  return (
    <div>
      ...
      {/* <p className="text-center leading-tight font-normal text-base md:text-lg md:leading-snug md:text-justify">
        ...
        elit. Error exercitationem quaerat sit ipsa itaque iusto porro, a dolore
        delectus, illo nemo quos! Accusantium et non perspiciatis quod
        voluptatem quis in! amet consectetur adipisicing elit. Sapiente, dolor
        est magnam similique eaque ipsum assumenda consequuntur recusandae
        excepturi, ut veritatis iure officia minus distinctio at laudantium
        officiis ullam quae?
      </p> */}
    </div>
  );
